...
if __name__ == "__main__":
    ...
    for input_path in tqdm(input_paths):
        ...
        #output_path = pathlib.Path(output_dir, f"{input_path.stem}_depth{prior_depth}.npy")
        output_path = pathlib.Path(output_dir, f"{input_path.stem}_1_depth{prior_depth}.mat")
        try:
            np.load(output_path)
            continue
        except:
        ...
        scipy.io.savemat(output_path, {'Representation':representation})
